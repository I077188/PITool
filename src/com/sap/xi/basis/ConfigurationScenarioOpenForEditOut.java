...
/**
 * <p>Java class for ConfigurationScenarioOpenForEditOut complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ConfigurationScenarioOpenForEditOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ChangeListID" type="{http://sap.com/xi/BASIS}ChangeListID" minOccurs="0"/>
 *         &lt;element name="ConfigurationScenario" type="{http://sap.com/xi/BASIS}ConfigurationScenario" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "ConfigurationScenarioOpenForEditOut", propOrder = {
    "changeListID",
    "configurationScenario",
    "logMessageCollection"
})
public class ConfigurationScenarioOpenForEditOut {

    @XmlElement(name = "ChangeListID")
    protected ChangeListID changeListID;
    @XmlElement(name = "ConfigurationScenario")
    protected List<ConfigurationScenario> configurationScenario;
     ...
     * {@link ConfigurationScenario }
     * 
     * 
     */
    public List<ConfigurationScenario> getConfigurationScenario() {
        if (configurationScenario == null) {
            configurationScenario = new ArrayList<ConfigurationScenario>();
        }
