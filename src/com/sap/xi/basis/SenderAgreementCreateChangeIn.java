...
/**
 * <p>Java class for SenderAgreementCreateChangeIn complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SenderAgreementCreateChangeIn">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ChangeListID" type="{http://sap.com/xi/BASIS}ChangeListChangeListID" minOccurs="0"/>
 *         &lt;element name="SenderAgreement" type="{http://sap.com/xi/BASIS}RestrictedSenderAgreement" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SenderAgreementCreateChangeIn", propOrder = {
    "changeListID",
    "senderAgreement"
})
public class SenderAgreementCreateChangeIn {

    @XmlElement(name = "ChangeListID")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String changeListID;
    @XmlElement(name = "SenderAgreement")
    protected List<RestrictedSenderAgreement> senderAgreement;
     ...
     * {@link RestrictedSenderAgreement }
     * 
     * 
     */
    public List<RestrictedSenderAgreement> getSenderAgreement() {
        if (senderAgreement == null) {
            senderAgreement = new ArrayList<RestrictedSenderAgreement>();
        }
