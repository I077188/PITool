...
/**
 * <p>Java class for ReceiverDeterminationOpenForEditOut complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ReceiverDeterminationOpenForEditOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ChangeListID" type="{http://sap.com/xi/BASIS}ChangeListID" minOccurs="0"/>
 *         &lt;element name="ReceiverDetermination" type="{http://sap.com/xi/BASIS}ReceiverDetermination" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "ReceiverDeterminationOpenForEditOut", propOrder = {
    "changeListID",
    "receiverDetermination",
    "logMessageCollection"
})
public class ReceiverDeterminationOpenForEditOut {

    @XmlElement(name = "ChangeListID")
    protected ChangeListID changeListID;
    @XmlElement(name = "ReceiverDetermination")
    protected List<ReceiverDetermination> receiverDetermination;
     ...
     * {@link ReceiverDetermination }
     * 
     * 
     */
    public List<ReceiverDetermination> getReceiverDetermination() {
        if (receiverDetermination == null) {
            receiverDetermination = new ArrayList<ReceiverDetermination>();
        }
