...
/**
 * <p>Java class for ValueMappingCreateChangeIn complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ValueMappingCreateChangeIn">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ChangeListID" type="{http://sap.com/xi/BASIS}ChangeListChangeListID" minOccurs="0"/>
 *         &lt;element name="ValueMapping" type="{http://sap.com/xi/BASIS}RestrictedValueMapping" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ValueMappingCreateChangeIn", propOrder = {
    "changeListID",
    "valueMapping"
})
public class ValueMappingCreateChangeIn {

    @XmlElement(name = "ChangeListID")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String changeListID;
    @XmlElement(name = "ValueMapping")
    protected List<RestrictedValueMapping> valueMapping;
     ...
     * {@link RestrictedValueMapping }
     * 
     * 
     */
    public List<RestrictedValueMapping> getValueMapping() {
        if (valueMapping == null) {
            valueMapping = new ArrayList<RestrictedValueMapping>();
        }
