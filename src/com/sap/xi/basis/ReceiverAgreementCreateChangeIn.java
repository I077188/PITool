...
/**
 * <p>Java class for ReceiverAgreementCreateChangeIn complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ReceiverAgreementCreateChangeIn">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ChangeListID" type="{http://sap.com/xi/BASIS}ChangeListChangeListID" minOccurs="0"/>
 *         &lt;element name="ReceiverAgreement" type="{http://sap.com/xi/BASIS}RestrictedReceiverAgreement" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ReceiverAgreementCreateChangeIn", propOrder = {
    "changeListID",
    "receiverAgreement"
})
public class ReceiverAgreementCreateChangeIn {

    @XmlElement(name = "ChangeListID")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String changeListID;
    @XmlElement(name = "ReceiverAgreement")
    protected List<RestrictedReceiverAgreement> receiverAgreement;
     ...
     * {@link RestrictedReceiverAgreement }
     * 
     * 
     */
    public List<RestrictedReceiverAgreement> getReceiverAgreement() {
        if (receiverAgreement == null) {
            receiverAgreement = new ArrayList<RestrictedReceiverAgreement>();
        }
